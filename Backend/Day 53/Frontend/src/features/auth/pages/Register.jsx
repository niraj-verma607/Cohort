        ...
        <div className="w-full max-w-md bg-[#131313] lg:bg-transparent p-10 md:p-14 lg:p-6 rounded-2xl lg:rounded-none shadow-[0_24px_48px_-12px_rgba(0,0,0,0.5)] lg:shadow-none">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-8">
            ...
            <a
              ...
              className="w-full border border-[#4d4732] text-[#e5e2e1] font-semibold tracking-wide py-4 px-8 rounded flex items-center justify-center gap-3 hover:border-[#FFD700] hover:text-[#FFD700] transition-colors duration-300"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 48 48"
              ...
              >
                <path
                  fill="#FFC107"
                  d="M43.611 20.083H42V20H24v8h11.303C33.652 32.657 29.233 36 24 36c-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.955 3.045l5.657-5.657C34.053 6.053 29.277 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"
                />
                <path
                  fill="#FF3D00"
                  d="M6.306 14.691l6.571 4.819C14.655 16.108 18.961 13 24 13c3.059 0 5.842 1.154 7.955 3.045l5.657-5.657C34.053 6.053 29.277 4 24 4c-7.682 0-14.417 4.337-17.694 10.691z"
                />
                <path
                  fill="#4CAF50"
                  d="M24 44c5.176 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.176 35.093 26.715 36 24 36c-5.212 0-9.617-3.319-11.283-7.946l-6.522 5.025C9.438 39.556 16.227 44 24 44z"
                />
                <path
                  fill="#1976D2"
                  d="M43.611 20.083H42V20H24v8h11.303a12.05 12.05 0 0 1-4.084 5.571h.001l6.19 5.238C36.971 39.205 44 34 44 24c0-1.341-.138-2.65-.389-3.917z"
                />
              </svg>
