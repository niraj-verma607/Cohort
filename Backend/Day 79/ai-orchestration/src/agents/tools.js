...
export const listFiles = tool(
  async ({}) => {
    ...
    const response = await axios.get(
      "http://019e3495-7e88-709b-86a2-b73e8f80b962.agent.localhost/list-files",
    );
...
export const readFiles = tool(
  async ({ files: [] }) => {
    ...
    const response = await axios.get(
      "http://019e3495-7e88-709b-86a2-b73e8f80b962.agent.localhost/read-files?files=" +
        files.join(","),
    );
...
export const updateFiles = tool(
  async ({ files }) => {
    ...
    const response = await axios.patch(
      "http://019e3495-7e88-709b-86a2-b73e8f80b962.agent.localhost/update-files",
      { updates: files },
    );
